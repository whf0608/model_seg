...
from MambaCD.changedetection.datasets.make_data_loader1 import MultimodalDamageAssessmentDatset
...
class Trainer(object):
    def __init__(self, args):
        ...
        train_data_loader = DataLoader(train_dataset, batch_size=self.args.batch_size, shuffle=True, num_workers=self.args.num_workers, drop_last=False)
    ...
    def validation(self):
        ...
        dataset = MultimodalDamageAssessmentDatset(self.args.test_dataset_path, self.args.test_data_name_list, self.args.crop_size, None, 'test')
...
def main():
    ...
    parser.add_argument('--train_dataset_path', type=str, default='/home/wanghaifeng/project_work/datasets/dfc25_track2_trainval//train')
    parser.add_argument('--train_data_list_path', type=str, default='/home/wanghaifeng/whf_work/work_sync/satellite_data/models_config/BRIGHT/dfc25_benchmark/dataset/splitname/train_setlevel.txt')
    parser.add_argument('--test_dataset_path', type=str, default='/home/wanghaifeng/project_work/datasets/dfc25_track2_trainval/train')
    parser.add_argument('--test_data_list_path', type=str, default='/home/wanghaifeng/whf_work/work_sync/satellite_data/models_config/BRIGHT/dfc25_benchmark/dataset/splitname/holdout_setlevel.txt')
