...
from modules.operates.covs.ghostcov import GhostConv
from modules.operates.covs.dwconv import DWConv
from modules.operates.covs.conv2dpadding import Conv2dStaticSamePadding,Conv2dDynamicSamePadding
from modules.operates.covs.cov_base import Conv
from modules.operates.covs.dorefaconv2d import DorefaConv2d,BNFold_DorefaConv2d,BNFold_Conv2d_Q,QuantizedConv2d
from modules.operates.covs.mixconv2d import MixConv2dv1,MixConv2dv2
from modules.operates.covs.separableconv import SeparableConv2d
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        self.cbr_unit = nn.Sequential(
                nn.BatchNorm2d(int(out_channels)), nn.ReLU(inplace=True)
            )
    ...
    def forward(self, x1, x2):
        ...
        return self.cbr_unit(self.conv(x))
