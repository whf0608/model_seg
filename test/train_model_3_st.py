...
config_path = r'model_config/xbdeq_FDD_model_config.json'
flag=None
...
def train(show):
    ...
    train_model(model,start_epoch=0,epochs=200,amp = False,device=device,n_classes=n_classes, trainloader=trainloader, valloader=valloader,optimizer=optimizer, scheduler=scheduler,get_loss_func=get_loss_func,get_val_func=get_loss_func,train_proccesing=train_proccesing,per_n=2,model_vis=False)
