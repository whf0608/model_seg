...
import torch
from modules.blocks.blocks import conv3x3, residualBlock
...
model = Model(64, 64, blocks=[conv3x3,residualBlock,conv3x3,conv3x3,conv3x3,conv3x3,conv3x3], repeats=[1,3,1,3,1,1,1],downs=[1,1,2,1,2,2,2])

imgs = torch.zeros((1,64,640,640))
